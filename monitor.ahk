...
{
  if (1 == _CatalystControlCenterActivate())
  {
    return
  }
...
_CatalystControlCenterActivate(is_retry=false)
{
  ...
  if (1 == WinWait(kCCCTitle, "", 5))
  {
    ...
    {
      return _CatalystControlCenterActivate(true)
    }
  }
...
_ReactiveColorControl()
{
  _CatalystControlCenterActivate()
